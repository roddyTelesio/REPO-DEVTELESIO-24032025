...
import threeDpErrorMessage from '@salesforce/label/c.threeDpErrorMessage'; //RRA - Ticket 2324 - 21/02/2025
...
export default class LWC29_AnswerRequests extends NavigationMixin(LightningElement) {
    ...
    label = {
        ...
        NumberErrorMessage,
        twoDpErrorMessage,
        threeDpErrorMessage,//RRA - Ticket 2324 - 21/02/2025
    ...
    maxLengthComments;
    wiredRequestDetails;
    isSpinnerSend = false; //RRA - Ticket 2221 - 17/12/2024
    greyOutPage = false;
    messageUser;
    isVisible = false;
    /*@track type='success';
    ...
    getRequestDetails(){
        ...
        .then(result => {
                ...
                for(let i = 0; i < this.lstTreaties.length; i++){
                    if(this.lstTreaties[i].value == key){
                        ...
                        for(let j = 0; j < lstSectionRequest.length; j++){
                            ...
                            if(rowSection.ReinsurerStatus__c == 'Timeout' || (rowSection.ReinsurerStatus__c == 'Answered' && today > rowSection.ExpectedResponseDate__c) || (rowSection.ReinsurerStatus__c == 'Refused' && today > rowSection.ExpectedResponseDate__c) || (rowSection.ReinsurerStatus__c == 'Sent' && rowSection.QuoteType__c == '2') || (rowSection.ReinsurerStatus__c == 'Informed' && rowSection.QuoteType__c == '2')){//RRA VERSIONING
                                rowSection['disableQuoteRequestInfo'] = true;
                            }
                            else{
                                rowSection['disableQuoteRequestInfo'] = false;
                            }
                            console.log('disableQuoteRequestInfo 22 == ',  rowSection['disableQuoteRequestInfo']);
            ...
            console.log('sendRequestAvailable == ', sendRequestAvailable);
            ...
            console.log('disableAllBtns == ', this.disableAllBtns);
    ...
    setTypeOfTreatyQuoteValue(rowSection){
        ...
        if(typeOfTreaty == '3'){
            ...
            rowSection['isTreatyTypeSurplus'] = false; //RRA - ticket 2204 - 09/12/2024
        ...
        /*1966*/
            ...
            rowSection['isTreatyTypeQS'] = false; //RRA - ticket 2204 - 09/12/2024
            rowSection['disableEstInsurance'] = true;
        }
    ...
    handleSaveAll(event){      
        ...
        if (btnName == 'Send'){
          this.isSpinnerSend = true;
          this.greyOutPage = true;
            ...
            .then(result => {
                ...
                if(result.hasOwnProperty('Error') && result.Error){
                    ...
                    if(btnName == 'Send'){
                        ...
                        this.getRequestDetails();
                        this.isVisible = true;
                        this.messageUser  = 'Please stay on this page until the sending confirmation message appears on your screen.';
                    }
                    else{
     ...
     //RRA - ticket 2245 - 27/12/2024
     handleCommentsChange_1(event){
         const inputField_Comments_1 = this.template.querySelector('[data-id="commentsId1"]');
          if (inputField_Comments_1.value.length > 3948){
            const isNotValid_1 = inputField_Comments_1.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
          }else{
            const isValid_1 = inputField_Comments_1.setCustomValidity(''); 
            this.maxLengthComments = 3950;
          }
        inputField.reportValidity();// Triggers validation, including messageWhenTooLong
     }

     handleCommentsChange_2(event){
         const inputField_Comments_2 = this.template.querySelector('[data-id="commentsId2"]');
          if (inputField_Comments_2.value.length > 3948){
            const isNotValid_2 = inputField_Comments_2.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
          }else{
            const isValid_2 = inputField_Comments_2.setCustomValidity(''); 
            this.maxLengthComments = 3950;
          }
        inputField.reportValidity();// Triggers validation, including messageWhenTooLong
     }

     handleCommentsChange_3(event){
         const inputField_Comments_3 = this.template.querySelector('[data-id="commentsId3"]');
          if (inputField_Comments_3.value.length > 3948){
            const isNotValid_3 = inputField_Comments_3.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
          }else{
            const isValid_3 = inputField_Comments_3.setCustomValidity(''); 
            this.maxLengthComments = 3950;
          }
        inputField.reportValidity();// Triggers validation, including messageWhenTooLong
     }

     handleCommentsChange_4(event){
         const inputField_Comments_4 = this.template.querySelector('[data-id="commentsId4"]');
          if (inputField_Comments_4.value.length > 3948){
            const isNotValid_4 = inputField_Comments_4.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
          }else{
            const isValid_4 = inputField_Comments_4.setCustomValidity(''); 
            this.maxLengthComments = 3950;
          }
        inputField.reportValidity();// Triggers validation, including messageWhenTooLong
     }

     handleCommentsChange_5(event){
         const inputField_Comments_5 = this.template.querySelector('[data-id="commentsId5"]');
          if (inputField_Comments_5.value.length > 3948){
            const isNotValid_5 = inputField_Comments_5.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
          }else{
            const isValid_5 = inputField_Comments_5.setCustomValidity(''); 
            this.maxLengthComments = 3950;
          }
        inputField.reportValidity();// Triggers validation, including messageWhenTooLong
     }

     handleCommentsChange_6 (event){
         const inputField_Comments_6 = this.template.querySelector('[data-id="commentsId6"]');
          if (inputField_Comments_6.value.length > 3948){
            const isNotValid_6 = inputField_Comments_6.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
          }else{
            const isValid_6 = inputField_Comments_6.setCustomValidity(''); 
            this.maxLengthComments = 3950;
          }
        inputField.reportValidity();// Triggers validation, including messageWhenTooLong
     }

     handleCommentsChange_7 (event){
         const inputField_Comments_7 = this.template.querySelector('[data-id="commentsId7"]');
          if (inputField_Comments_7.value.length > 3948){
            const isNotValid_7 = inputField_Comments_7.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
          }else{
            const isValid_7 = inputField_Comments_7.setCustomValidity(''); 
            this.maxLengthComments = 3950;
          }
        inputField.reportValidity();// Triggers validation, including messageWhenTooLong
     }

     handleCommentsChange_8 (event){
         const inputField_Comments_8 = this.template.querySelector('[data-id="commentsId8"]');
          if (inputField_Comments_8.value.length > 3948){
            const isNotValid_8 = inputField_Comments_8.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
          }else{
            const isValid_8 = inputField_Comments_8.setCustomValidity(''); 
            this.maxLengthComments = 3950;
          }
        inputField.reportValidity();// Triggers validation, including messageWhenTooLong
     }

     handleCommentsChange_9 (event){
         const inputField_Comments_9 = this.template.querySelector('[data-id="commentsId9"]');
          if (inputField_Comments_9.value.length > 3948){
            const isNotValid_9 = inputField_Comments_9.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
          }else{
            const isValid_9 = inputField_Comments_9.setCustomValidity(''); 
            this.maxLengthComments = 3950;
          }
        inputField.reportValidity();// Triggers validation, including messageWhenTooLong
     }
     ...
     handleCommentsChange_10 (event){
         const inputField_Comments_10 = this.template.querySelector('[data-id="commentsId10"]');
          if (inputField_Comments_10.value.length > 3948){
            const isNotValid_10 = inputField_Comments_10.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
          }else{
            const isValid_10 = inputField_Comments_10.setCustomValidity(''); 
            this.maxLengthComments = 3950;
          }
        inputField.reportValidity();// Triggers validation, including messageWhenTooLong
     }

     handleCommentsChange_11 (event){
         const inputField_Comments_11 = this.template.querySelector('[data-id="commentsId11"]');
          if (inputField_Comments_11.value.length > 3948){
            const isNotValid_10 = inputField_Comments_11.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
          }else{
            const isValid_10 = inputField_Comments_11.setCustomValidity(''); 
            this.maxLengthComments = 3950;
          }
        inputField.reportValidity();// Triggers validation, including messageWhenTooLong
     }

     handleCommentsChange_13 (event){
         const inputField_Comments_13 = this.template.querySelector('[data-id="commentsId13"]');
          if (inputField_Comments_13.value.length > 3948){
            const isNotValid_13 = inputField_Comments_13.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
          }else{
            const isValid_13 = inputField_Comments_13.setCustomValidity(''); 
            this.maxLengthComments = 3950;
          }
        inputField.reportValidity();// Triggers validation, including messageWhenTooLong
     }
     ...
     //RRA - To decommented in the future for optimization 
    /*handleCommentsChange(event){
       var selectNameComments = event.currentTarget.dataset.name;
       if (selectNameComments == 'commentsId1'){
           const inputField_Comments_1 = this.template.querySelector('[data-id="commentsId1"]');
          if (inputField_Comments_1.value.length > 3950){
            const isNotValid_1 = inputField_Comments_1.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
          }else{
            const isValid_1 = inputField_Comments_1.setCustomValidity(''); 
            this.maxLengthComments = 4000;
          }
          inputField.reportValidity();// Triggers validation, including messageWhenTooLong
       }else if (selectNameComments == 'commentsId2'){
          const inputField_Comments_2 = this.template.querySelector('[data-id="commentsId2"]');
          if (inputField_Comments_2.value.length > 3948){
            const isNotValid_2 = inputField_Comments_2.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
          }else{
          ...
          inputField.reportValidity();// Triggers validation, including messageWhenTooLong
      }else if (selectNameComments == 'commentsId3'){
          const inputField_Comments_3 = this.template.querySelector('[data-id="commentsId3"]');
          if (inputField_Comments_3.value.length > 3948){
            const isNotValid_3 = inputField_Comments_3.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
          }else{
          ...
          inputField.reportValidity();// Triggers validation, including messageWhenTooLong
      }else if (selectNameComments == 'commentsId4'){
            const inputField_Comments_4 = this.template.querySelector('[data-id="commentsId4"]');
            if (inputField_Comments_4.value.length > 3948){
              const isNotValid_4 = inputField_Comments_4.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
            }else{
            ...
            inputField.reportValidity();// Triggers validation, including messageWhenTooLong
      }else if (selectNameComments == 'commentsId5'){
              const inputField_Comments_5 = this.template.querySelector('[data-id="commentsId5"]');
              if (inputField_Comments_5.value.length > 3948){
                const isNotValid_5 = inputField_Comments_5.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
              }else{
            ...
            inputField.reportValidity();// Triggers validation, including messageWhenTooLong
      }else if (selectNameComments == 'commentsId6'){
              const inputField_Comments_6 = this.template.querySelector('[data-id="commentsId6"]');
              if (inputField_Comments_6.value.length > 3948){
                const isNotValid_6 = inputField_Comments_6.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
              }else{
            ...
            inputField.reportValidity();// Triggers validation, including messageWhenTooLong
      }else if (selectNameComments == 'commentsId7'){
              const inputField_Comments_7 = this.template.querySelector('[data-id="commentsId7"]');
              if (inputField_Comments_7.value.length > 3948){
                const isNotValid_7 = inputField_Comments_7.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
              }else{
             ...
             inputField.reportValidity();// Triggers validation, including messageWhenTooLong
      }else if (selectNameComments == 'commentsId8'){
                const inputField_Comments_8 = this.template.querySelector('[data-id="commentsId8"]');
                if (inputField_Comments_8.value.length > 3948){
                  const isNotValid_8 = inputField_Comments_8.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
                }else{
              ...
              inputField.reportValidity();// Triggers validation, including messageWhenTooLong
      }else if (selectNameComments == 'commentsId9'){
                 const inputField_Comments_9 = this.template.querySelector('[data-id="commentsId9"]');
                if (inputField_Comments_9.value.length > 3948){
                  const isNotValid_9 = inputField_Comments_9.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
                }else{
              ...
              inputField.reportValidity();// Triggers validation, including messageWhenTooLong
      }else if (selectNameComments == 'commentsId10'){
                   const inputField_Comments_10 = this.template.querySelector('[data-id="commentsId10"]');
                  if (inputField_Comments_10.value.length > 3948){
                    const isNotValid_10 = inputField_Comments_10.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
                  }else{
                ...
                inputField.reportValidity();// Triggers validation, including messageWhenTooLong
      }else if (selectNameComments == 'commentsId11'){
                  const inputField_Comments_11 = this.template.querySelector('[data-id="commentsId11"]');
                  if (inputField_Comments_11.value.length > 3948){
                    const isNotValid_10 = inputField_Comments_11.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
                  }else{
                ...
                inputField.reportValidity();// Triggers validation, including messageWhenTooLong
      }else if (selectNameComments == 'commentsId13'){
                    const inputField_Comments_13 = this.template.querySelector('[data-id="commentsId13"]');
                    if (inputField_Comments_13.value.length > 3948){
                      const isNotValid_13 = inputField_Comments_13.setCustomValidity('Your comment must not exceed 3950 characters. You can send your comment into a document that you can attach to your reply. You can send your comment into a document that you can attach to your reply'); 
                    }else{
   ...
   sendMail(){ 
        ...
        //RRA - ticket 2221 - 18/12/2024
        if (this.isVisible){
          this.template.querySelector('c-lwc-29-toast-msg-send-on-portal').showToast('warning','<strong>' + this.messageUser + '</strong>' ,'',20000);
        }
    ...
    //BBU 13.11.24 -> Disable
    handleDocumentButtons(e){
        this.displaySpinner = e.detail.displaySpinner;
    }
}