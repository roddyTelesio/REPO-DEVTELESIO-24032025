...
export default class LWC20_LeadRequests extends NavigationMixin(LightningElement) {
    ...
    @wire(getSectionDetail, {programId: '$selectedProgram', treatyId: '$selectedTreaty', reinsurerId: '$selectedReinsurer', brokerId: '$selectedBroker', reinsurerStatus: '$selectedReinsurerStatus', isDirect : '$selectIsDirect' })  //RRA - ticket 585 - 15032023
