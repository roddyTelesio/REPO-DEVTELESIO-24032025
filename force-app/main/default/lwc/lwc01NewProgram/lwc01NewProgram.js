...
export default class LWC01_NewProgram extends NavigationMixin(LightningElement) {
    ...
    createProgramPage;
    isSaveProgramFromTreaty = false; //RRA - 1372 - 02102024
    preSelectedRowsCCC = [];//RRA - 1840 - 09092024
    ...
    connectedCallback(){
        ...
        if(this.isProgramCopy == true || this.isProgramEdit == true){
            ...
            console.log('capitalManagementValue == ', this.selectedProgram.CapitalManagement__c);
    ...
    setPicklistOptions({error, data}) {
        if(data){
            //let refreshUWYear = localStorage.getItem('refreshUWY');
            //console.log('refreshUWYear uwYearOpenModal == ', refreshUWYear);
            console.log('uwYearOpenModal setPicklistOptions av == ', this.uwYearOpenModal);
            console.log('createPage setPicklistOptions == ', this.createPage);
            console.log('conditionPage setPicklistOptions == ', this.conditionPage);
            if(this.createPage == 'yes' || this.conditionPage){
                this.uwYearOpenModal = data.values[data.values.length - 1].value;
            }
            
            //RRA - ticket 1961 - 04032024
            /*if(this.createPage == undefined || this.conditionPage == false){
                this.uwYearOpenModal =  (this.uwYearOpenModal != undefined) ? this.uwYearOpenModal : data.values[data.values.length - 1].value;
                console.log('uwYearOpenModal setPicklistOptions ap== ', this.uwYearOpenModal);
            }*/
    ...
    handleSubmitCompany(){
        ...
        for(var i = 0; i < this.covData.length; i++){
            coveredCedingCompIds.push(this.covData[i].recId); //RRA - 1840 - 09092024
        }
        this.preSelectedRowsCCC = coveredCedingCompIds; //RRA - 1840 - 09092024
    ...
    handleSaveProgramTP(){
        ...
        || (this.objProgram.LossDeposit__c == '1' && (this.objProgram.LossDepositLevel__c == null || this.objProgram.LossDepositLevel__c == "" || this.objProgram.LossDepositLevel__c == undefined))
            ...
            if (this.isSaveProgramFromTreaty == false){ //RRA - 1372 - 02102024
                this.dispatchEvent(new ShowToastEvent({title: 'ERROR', message: this.label.Required_Fields, variant: 'error'}),);
            }
            //this.dispatchEvent(new ShowToastEvent({title: 'ERROR', message: this.label.Required_Fields, variant: 'error'}),);
            this.spinner = false;
    ...
    getCoveredCedingCompaniesEdit(selectedProgramId){
        ...
        .then(result => {
            ...
            console.log('covData 00== ', this.covData);
            console.log('preSelectedRowsCCC 00== ', this.preSelectedRowsCCC);
