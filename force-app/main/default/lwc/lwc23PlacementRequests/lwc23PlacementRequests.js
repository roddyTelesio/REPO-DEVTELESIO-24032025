...
export default class Lwc23PlacementRequests extends NavigationMixin(LightningElement) {
    ...
    @api selectIsDirect = false;//RRA - ticket 1091 - 16072024
    ...
    @wire(getPlacementRequests, {programId: '$selectedProgram', treatyId: '$selectedTreaty', reinsurerId: '$selectedReinsurer', brokerId: '$selectedBroker', reinsurerStatus: '$selectedReinsurerStatus', isDirect : '$selectIsDirect' })  //RRA - ticket 585 - 15032023
