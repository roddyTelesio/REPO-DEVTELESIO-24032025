...
const columns1 = [
    { label: 'Legend', fieldName: 'statusIcon' , type: 'button-icon', typeAttributes: { iconName: 'utility:record', iconClass: { fieldName: 'classStatusIcon' }, variant:'bare'}},
    { label: 'Status', fieldName: 'statusMessage'},
    { label: 'Reinsurer', fieldName: 'reinsurerName'},
    { label: 'Principal Ceding Company', fieldName: 'pccName'},
    { label: 'Name', fieldName: 'programUrl', type: 'url', typeAttributes: {label: {fieldName: 'programName'}, target: '_self'} },
    { label: 'Expected Answer Date', fieldName: 'expectedAnswerDate'},
    { label: 'Last Answer Date', fieldName: 'lastAnswerDate'}
];
    ...
    getRequestsInfo(){
         ...
         if(this.current_valueReinsurerId != this.valueReinsurerId || 
            ...
            this.current_valuePrincipalCedComp != this.valuePrincipalCedComp){
             ...
             if (isPortalSession == 'true'){
                 console.log('isPortalSession true');
                 this.getRequestsInfoOnPortal(null, this.valIsBroker, valueUWYearSessionPortal, valuePccSessionPortal);
             }else{
                 //RRA - ticket 1839 - 05042023
                 console.log('isPortalSession false');
                if (this.current_valueUWYear != undefined && this.current_valuePrincipalCedComp != undefined){
        ...
        getRequestsInfoOnPortal (valReinsId, valBroker, valUWY, valPCC){
            ...
            .then(result => {
                ...
                console.log('** ZJO lstReqWrapper', result.lstReqWrapper);
                ...
                this.requestsData = result.lstReqWrapper;
