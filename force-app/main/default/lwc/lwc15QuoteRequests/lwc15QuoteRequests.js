...
export default class LWC15_QuoteRequests extends NavigationMixin(LightningElement) {
    ...
    @api selectIsDirect = false; //RRA - ticket 1091 - 15072024
    @api selectIsBrokerAll = false; //RRA - ticket 1091 - 15072024
    @api selectedReinsurer = null;
    @api selectedReinsurerStatus = null;
    @api selectedQuoteType = null;  // HRA W-1096 - QuoteType Filter
    ...
    connectedCallback(){
        ...
        registerListener('isDirect', this.getIsDirect, this);//RRA - ticket 1091 - 15072024
        ...
        registerListener('valueQuoteType', this.getValueQuoteType, this);  // HRA W-1096 - QuoteType Filter
    ...
    getValueQuoteType(val){
        this.selectedQuoteType = val;
        this.spinnerQuoteRequest = true;
        this.getQuoteRequests();
    }
    ...
    getQuoteRequests(){
        ...
        //RRA - ticket 1091 - 15072024
        if (this.selectedBroker == 'All' || this.selectedBroker == null){
            this.selectedBroker = null;
            this.selectIsDirect = false;
        }else if (this.selectedBroker == 'direct'){
            this.selectedBroker = null;
            this.selectIsDirect = true;
        }else if (this.selectedBroker.includes('001')){
            this.selectedBroker = this.selectedBroker;
            this.selectIsDirect = false;
        }
        
        console.log('this.selectedBroker == ', this.selectedBroker);
        console.log('this.selectIsDirect == ', this.selectIsDirect);
        getQuoteRequests({  programId: this.selectedProgram,
                            treatyId: this.selectedTreaty,
                            reinsurerId: this.selectedReinsurer,
                            brokerId: this.selectedBroker,//RRA - ticket 1091 - 15072024
                            isDirect : this.selectIsDirect,//RRA - ticket 1091 - 15072024
                            reinsurerStatus: this.selectedReinsurerStatus,//RRA - ticket 585 - 15032023
                            quoteType: this.selectedQuoteType // HRA W-1096 - QuoteType Filter
                        })
        .then(result => {
            ...
            refreshApex( result.lstQuoteRequestsToDisplay);
    ...
    handleOpenSendUpdateRemindModal(event){
        ...
        if (errorClickBtn){
          ...
          console.log('error handleOpenSendUpdateRemindModal == ', error.message);
        }
