    ...
    handleSaveLeadRequest(){
        ...
        if(allValid) {
            ...
            for(let i = 0; i < this.lstSectionRequestRetainToLead.length; i++){
                ...
                rowRequest['QuoteOnBehalf__c'] = 'false';//RRA VERSIONING
                rowRequest['LeadOnBehalf__c'] = 'false'; //RRA VERSIONING
                rowRequest['PlacementOnBehalf__c'] = 'false'; //RRA VERSIONING
        ...
        if(result.data){
            ...
            for(let j = 0; j < this.lstSectionRequestRetainToLead.length; j++){
                ...
                //AXA XL QS + (FlatCommission or VariableCommission or RiskPremiumBasis or PerHead)
                    ...
                    let cededPremiumValue = totalEPI * (rowSection.Cession_Perc__c/100); 
